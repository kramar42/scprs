...
impl R201 {
    ...
    pub fn e0() -> Self { R201::new(1.0, 1) }
    pub fn e1() -> Self { R201::new(1.0, 2) }
    pub fn e2() -> Self { R201::new(1.0, 3) }
    pub fn e01() -> Self { R201::new(1.0, 4) }
    pub fn e02() -> Self { R201::new(1.0, 5) }
    pub fn e12() -> Self { R201::new(1.0, 6) }
    pub fn e012() -> Self { R201::new(1.0, 7) }
}

impl Index<usize> for R201 {
    type Output = float_t;
...
impl IndexMut<usize> for R201 {
    fn index_mut<'a>(&'a mut self, index: usize) -> &'a mut Self::Output {
        &mut self.mvec[index]
    }
}

impl fmt::Display for R201 {
...
impl R201 {
    pub fn Conjugate(self: & Self) -> R201 {
        let mut res = R201::zero();
        let a = self;
        res[0]=a[0];
        res[1]=-a[1];
...
// Main involution
impl R201 {
    pub fn Involute(self: & Self) -> R201 {
        let mut res = R201::zero();
        let a = self;
        res[0]=a[0];
        res[1]=-a[1];
...
define_binary_op_all!(
    Mul,
    mul;
    self: float_t, b: R201, Output = R201;
    [val val] => &self * &b;
    [ref val] =>  self * &b;
    [val ref] => &self *  b;
    [ref ref] => {
...
define_binary_op_all!(
    Mul,
    mul;
    self: R201, b: float_t, Output = R201;
    [val val] => &self * &b;
    [ref val] =>  self * &b;
    [val ref] => &self *  b;
    [ref ref] => {
